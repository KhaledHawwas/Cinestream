                ...
                if (task.isSuccessful) {
                    ...
                    firestore.collection("users").document(userId)
                        ...
                        .addOnSuccessListener {
                            // Send email verification - ActionCodeSettings removed for simplicity
                            // If you need custom email handling, configure it in Firebase Console
                            user.sendEmailVerification()
                                ...
                                .addOnFailureListener { e ->
                                    _authState.value = AuthState.Error(
                                        if (isArabic)
                                            "??U� ?�U�?�?�?? ?�U�?�?�?�?�?� U�U�U� U??�U� ?�?�?�?�U� ?�?�?�U�?� ?�U�??U??�U?U�: ${e.message}"
                                        else
                        ...
                        .addOnFailureListener { e ->
                            _authState.value = AuthState.Error(
                                e.message ?: if (isArabic) "?�?�?� ?�?�?� ?�?�U�?�?? ?�U??� ?�U�?�U??�U�?�??." else "Error saving data."
                            )
                        }
                } else {
                    _authState.value = AuthState.Error(
                        task.exception?.message ?: if (isArabic) "U??�U� ?�U�?�?�?? ?�U�?�?�?�?�?� ?�?�U�U� U�?�?� ?�?�?�U�." else "Sign up failed. Please try again."
                    )
                }
            }
    }
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    if (user != null && user.isEmailVerified) {
                        ...
                        _authState.value = AuthState.Success(
                            if (isArabic) "??U� ???�?�U?U� ?�U�?�?�U�U� ?�U�?�?�?�!" else "Signed in successfully!"
                        )
                    } else {
                        auth.signOut()
                        _authState.value = AuthState.Error(
                            if (isArabic) "U??�?�U� ??U??�U?U� ?�?�U??�U� ?�U�?�U�U�???�U�U�U? ?�U�U�?�U�." else "Please verify your email first."
                        )
                    }
                } else {
                    _authState.value = AuthState.Error(
                        task.exception?.message ?: if (isArabic) "?�U??�U�?�?? ?�U�?�?�U�U� ??U??� ?�?�U??�?�." else "Invalid credentials."
                    )
                }
            }
    }
